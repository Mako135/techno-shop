...
const SparkSectionNine = () => {
  ...
  const phone_1 =
    "https://d3fyizz0b46qgr.cloudfront.net/global/SPARK_20/en/new_1209/dist/png/sec9PcMagicSkin.png";
  const phone_2 =
    "https://d3fyizz0b46qgr.cloudfront.net/global/SPARK_20/en/new_1209/dist/png/sec9PcBlack.png";
  const phone_3 =
    "https://d3fyizz0b46qgr.cloudfront.net/global/SPARK_20/en/new_1209/dist/png/sec9PcGold.png";
  const phone_4 =
    "https://d3fyizz0b46qgr.cloudfront.net/global/SPARK_20/en/new_1209/dist/png/sec9PcWhite.png";
  return (
      ...
      <header>
        ...
        <div className="section-right2">
          ...
          <div className="sec-nine-datas">
            <div className="data">
              <h6>Композитный пластик</h6>
              <p>Изящный матовый корпус</p>
            </div>
            <div className="data">
              <h6>Glitter Sand 2.0</h6>
              <p>Переливающийся эффект</p>
            </div>
            <div className="data">
              <h6>Трендовые цвета</h6>
...
export default SparkSectionNine;
