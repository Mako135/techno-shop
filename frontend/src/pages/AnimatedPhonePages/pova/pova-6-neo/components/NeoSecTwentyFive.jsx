...
const NeoSecTwentyFive = () => {
  ...
  const figure =
    "https://d3fyizz0b46qgr.cloudfront.net/global/phones/pova6-neo/ru/assets/images/chapter6/chapter6-bg-right.webp";
  return (
    <div className="neo-5">
      <h2 className="neo-5-subtitle">POVA 6 NEO ─ Система</h2>
...
export default NeoSecTwentyFive